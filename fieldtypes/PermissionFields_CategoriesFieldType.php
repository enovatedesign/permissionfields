...
/**
 * Permission Fields Categories Field Type class
 *
 ...
 * @since     1.0.0
 */
class PermissionFields_CategoriesFieldType extends CategoriesFieldType
{
	public function getName()
	{
		return Craft::t('Permission Categories');
	}
